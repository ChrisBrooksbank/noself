...
- [x] Add `terms` field to Puja types + loaders — currently silently dropped from YAML (spec: specs/sanskrit-ui.md)
- [x] Add loader tests to verify terms are parsed for sutras and pujas (spec: specs/sanskrit-ui.md)
...
- [x] Puja study view — same interactive term + gloss pattern as sutra (spec: specs/sanskrit-ui.md)
- [x] Mantra detail view — add phonetic display alongside syllables (spec: specs/sanskrit-ui.md)
...
- [x] Update existing view tests to verify terms display (spec: specs/sanskrit-ui.md)
